								...
								<div class="img-wrap is-round-post-img">
									...
									<div class="img-item">
										<img <?php echo $img_src;?> alt="<?php echo $list[$i]['img']['alt'];?>" class="wr-img">
											...
											<div class="in-subject ellipsis trans-bg-black-new">
												<?php if($is_date || $list[$i]['wr_2']) { ?>
													<span class="pull-right">
														<?php if ($list[$i]['wr_4']) { ?>
															<span class="count orangered" style="color:yellow; font-size:1em;">+<?php echo $list[$i]['wr_4']; ?></span>
														<?php } ?>
													</span>
												<?php } ?>
												<span style="font-size:2em; color:#fff; font-weight:700; margin-top:5px;text-shadow: 0 0 2px #000;"><?php echo $list[$i]['wr_2'];?><span style="font-size:0.7em; color:#fff; font-weight:700; margin-top:5px;">(<?php echo $list[$i]['wr_3'];?>)</span>
                                                <p style="font-size:0.8em; color:#fff; font-weight:700; margin-top:24px;text-align: center;"><?php echo $list[$i]['wr_name'];?></p>
											</div>
