    ...
    for ($i=0; $i<count($_POST['chk']); $i++) {
        ...
        $sql = "update {$g5['g5_shop_item_table']}
                   set ca_id          = '".sql_real_escape_string($_POST['ca_id'][$k])."',
                       ...
                       pt_commission  = '".sql_real_escape_string($_POST['pt_commission'][$k])."',
					   pt_incentive   = '".sql_real_escape_string($_POST['pt_incentive'][$k])."',
					   pt_it		  = '".sql_real_escape_string($_POST['pt_it'][$k])."',
					   pt_main		  = '".sql_real_escape_string($_POST['pt_main'][$k])."',
					   pt_comment_use = '".sql_real_escape_string($_POST['pt_comment_use'][$k])."',
